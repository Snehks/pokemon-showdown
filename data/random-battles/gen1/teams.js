...
exports.RandomGen1Teams = void 0;
const teams_1 = __importDefault(require("../gen2/teams"));
const lib_1 = require("../../../lib");
class RandomGen1Teams extends teams_1.default {
    constructor() {
        super(...arguments);
    ...
    randomSet(species) {
        ...
        if (!species.exists)
            species = this.dex.species.get('pikachu'); // Because Gen 1.
        ...
        for (const forme of randomN) {
            ...
            if (!hackmonsCup[species.id]) {
                hackmonsCup[species.id] = {
                    ...
                    baseStats: {
                        hp: lib_1.Utils.clampIntRange(this.random(256), 1),
                        atk: lib_1.Utils.clampIntRange(this.random(256), 1),
                        def: lib_1.Utils.clampIntRange(this.random(256), 1),
                        spa: lib_1.Utils.clampIntRange(this.random(256), 1),
                        spd: 0,
                        spe: lib_1.Utils.clampIntRange(this.random(256), 1),
                    },
                };
