...
// [PBO] Cosmetic event form definitions.
...
const PBO_EVENT_FORMS: [string, string, string, string][] = [
	...
	["latiass3", "latias", "Latias-S3", "S3"],
	["latioss", "latios", "Latios-S", "S"],
	["latioss2", "latios", "Latios-S2", "S2"],
	["latioss3", "latios", "Latios-S3", "S3"],
	...
	["volcanions3", "volcanion", "Volcanion-S3", "S3"],
	...
	// Summer 2026 (S3) event forms
	["froakies3", "froakie", "Froakie-S3", "S3"],
	["frogadiers3", "frogadier", "Frogadier-S3", "S3"],
	["greninjas3", "greninja", "Greninja-S3", "S3"],
	["whimsicotts3", "whimsicott", "Whimsicott-S3", "S3"],
	["sceptiles3", "sceptile", "Sceptile-S3", "S3"],
	["samurotthisuis3", "samurotthisui", "Samurott-Hisui-S3", "S3"],
	["gliscors3", "gliscor", "Gliscor-S3", "S3"],
	["flareons3", "flareon", "Flareon-S3", "S3"],
	["venusaurs3", "venusaur", "Venusaur-S3", "S3"],
	["grimmsnarls3", "grimmsnarl", "Grimmsnarl-S3", "S3"],
	["salamences3", "salamence", "Salamence-S3", "S3"],
	["terrakions3", "terrakion", "Terrakion-S3", "S3"],
	["pecharunts3", "pecharunt", "Pecharunt-S3", "S3"],
	["barbaracles3", "barbaracle", "Barbaracle-S3", "S3"],
	["zangooses3", "zangoose", "Zangoose-S3", "S3"],
	...
	["vaporeons3", "vaporeon", "Vaporeon-S3", "S3"],
	["glaceons3", "glaceon", "Glaceon-S3", "S3"],
	["crawdaunts3", "crawdaunt", "Crawdaunt-S3", "S3"],
	["gyaradosmegas3", "gyaradosmega", "Gyarados-Mega-S3", "S3"],
	["venusaurmegas3", "venusaurmega", "Venusaur-Mega-S3", "S3"],
	["salamencemegas3", "salamencemega", "Salamence-Mega-S3", "S3"],
	["sceptilemegas3", "sceptilemega", "Sceptile-Mega-S3", "S3"],
];
...
export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		for (const [eventId, baseId, displayName, forme] of PBO_EVENT_FORMS) {
			...
			// Clone base species data with event form identity overrides.
			// All battle-relevant properties (stats, types, abilities, canMegaEvo,
			// canGigantamax, battleOnly, etc.) are inherited from the base as-is.
	...
	field: {
		...
		clearWeather() {
			...
			// PBO: Restore permanent weather if one was set at battle start
			const permaId = (this as any).pboPermaWeather;
			if (permaId) {
		...
		clearTerrain() {
			...
			// PBO: Restore permanent terrain if one was set at battle start
			const permaId = (this as any).pboPermaTerrain;
			if (permaId) {
				const status = this.battle.dex.conditions.get(permaId);
