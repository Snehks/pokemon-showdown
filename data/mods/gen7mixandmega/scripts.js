...
exports.Scripts = {
    ...
    actions: {
        ...
        runMegaEvo(pokemon) {
            ...
            const species = this.getMixedSpecies(pokemon.m.originalSpecies, pokemon.canMegaEvo || pokemon.canUltraBurst, pokemon);
        ...
        getFormeChangeDeltas(formeChangeSpecies, pokemon) {
            ...
            const baseSpecies = this.dex.species.get(formeChangeSpecies.isMega ?
                formeChangeSpecies.battleOnly : formeChangeSpecies.baseSpecies);
            const deltas = {
