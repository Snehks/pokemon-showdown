...
const field_1 = require("../../../sim/field");
exports.Scripts = {
    gen: 9,
    inherit: 'gen9',
    fieldEvent(eventid, targets) {
        ...
        while (handlers.length) {
            ...
            if (handler.state?.target instanceof sim_1.Pokemon) {
            ...
            else if (handler.state?.target instanceof sim_1.Side && !handler.state.isSlotCondition) {
