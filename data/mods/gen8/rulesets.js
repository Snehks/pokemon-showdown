    ...
    godlygiftmod: {
        ...
        onValidateTeam(team) {
            ...
            for (const set of team) {
                ...
                if (['ag', 'uber'].includes(this.toID(this.ruleTable.has('natdexmod') ? species.natDexTier : species.tier)) ||
        ...
        onModifySpecies(species, target, source) {
            ...
            const god = target.side.team.find(set => {
                ...
                const validator = this.dex.formats.getRuleTable(this.dex.formats.get(`gen${this.gen}${isNatDex && this.gen >= 8 ? 'nationaldex' : 'ou'}`));
