            ...
            for (const pokemon of sortedActive) {
                ...
                if (!this.dex.abilities.get(pokemon.ability).exists) {
                    ...
                    if (isItem >= 0) {
                        ...
                        const findMove = pokemon.m.scrambled.moves.findIndex(e => e.inSlot === 'Ability');
        ...
        onUpdate(pokemon) {
            ...
            if (this.toID(pokemon.item) === 'trace') {
                ...
                if (this.dex.abilities.get(ability.name).exists) {
                    ...
                    pokemon.m.scrambled.abilities.splice(pokemon.m.scrambled.abilities.findIndex(e => this.toID(e.thing) === 'trace' && e.inSlot === 'Move'), 1);
                    this.add('-ability', pokemon, ability.name, 'Trace');
