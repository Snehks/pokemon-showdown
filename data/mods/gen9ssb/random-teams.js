...
exports.RandomStaffBrosTeams = exports.ssbSets = void 0;
const teams_1 = __importDefault(require("../../random-battles/gen9/teams"));
exports.ssbSets = {
    /*
    // Example:
    Username: {
...
class RandomStaffBrosTeams extends teams_1.default {
    randomStaffBrosTeam(options = {}) {
        ...
        let pool = meme ? Object.keys(afdSSBSets) : Object.keys(exports.ssbSets);
        if (debug.length) {
            while (debug.length < 6) {
                const staff = this.sampleNoReplace(pool);
                if (debug.includes(staff) || exports.ssbSets[staff].skip)
                    continue;
                debug.push(staff);
            }
            pool = debug;
        ...
        while (pool.length && team.length < this.maxTeamSize) {
            ...
            const ssbSet = meme ? this.dex.deepClone(afdSSBSets[name]) : this.dex.deepClone(exports.ssbSets[name]);
            if (ssbSet.skip)
                continue;
...
exports.RandomStaffBrosTeams = RandomStaffBrosTeams;
exports.default = RandomStaffBrosTeams;
