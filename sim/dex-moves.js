...
class DataMove extends dex_data_1.BasicEffect {
    constructor(data) {
        ...
        this.type = utils_1.Utils.getString(data.type);
        this.target = data.target;
        this.basePower = Number(data.basePower);
        this.accuracy = data.accuracy;
        this.critRatio = Number(data.critRatio) || 1;
        this.baseMoveType = utils_1.Utils.getString(data.baseMoveType) || this.type;
...
const EMPTY_MOVE = utils_1.Utils.deepFreeze(new DataMove({ name: '', exists: false }));
class DexMoves {
    constructor(dex) {
