...
const Moves = {
  ...
  focuspunch: {
    inherit: true,
    priorityChargeCallback: void 0,
    // no inherit
    beforeTurnCallback(pokemon) {
      pokemon.addVolatile("focuspunch");
    },
    beforeMoveCallback: void 0,
    // no inherit
    onTry(pokemon) {
  ...
  gravity: {
    ...
    condition: {
      ...
      onFieldResidualSubOrder: void 0
      // no inherit
    }
  },
  growth: {
