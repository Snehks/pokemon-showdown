  ...
  */
  ...
  hacking: {
    ...
    onStart(pokemon) {
      ...
      this.add(
        "message",
        `${name} hacked into PS and looked at ${name === "Cassiopeia" ? "her" : "their"} opponent's sets. ${warnTarget.name}'s move ${warnMoveName} drew ${name === "Cassiopeia" ? "her" : "their"} eye.`
      );
