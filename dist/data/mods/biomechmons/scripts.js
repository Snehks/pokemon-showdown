  ...
  pokemon: {
    ...
    ignoringAbility() {
      ...
      for (const pokemon of this.battle.getAllActive()) {
        if ((pokemon.ability === "neutralizinggas" || pokemon.m.scrambled.abilities.some(
      ...
      return !!(this.battle.gen >= 5 && !this.isActive || (this.volatiles["gastroacid"] || neutralizinggas && (this.ability !== "neutralizinggas" || this.m.scrambled.abilities.some((abils) => this.battle.toID(abils.thing) === "neutralizinggas"))) && !this.getAbility().flags["cantsuppress"]);
    },
    ...
    takeItem(source) {
      ...
      if (this.battle.gen <= 4) {
        ...
        if (this.battle.toID(source.ability) === "multitype" || source.m.scrambled.abilities.findIndex((e) => this.battle.toID(e.thing) === "multitype") >= 0) {
          return false;
        }
      }
