      ...
      if (sourceIsBMM) {
        ...
        if (isItem >= 0) {
          ...
          source.baseMoveSlots.splice(
            source.baseMoveSlots.findIndex((m) => this.toID(source.m.scrambled.moves[isMove].thing) === m.id),
            1
          );
      ...
      if (targetIsBMM) {
        ...
        if (isItem >= 0) {
          ...
          target.baseMoveSlots.splice(
            target.baseMoveSlots.findIndex((m) => this.toID(target.m.scrambled.moves[isMove].thing) === m.id),
            1
          );
