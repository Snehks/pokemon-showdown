...
class RandomRGTeams extends import_teams.RandomTeams {
  constructor() {
    super(...arguments);
  ...
  randomSet(s, teamDetails = {}, isLead = false, isDoubles = false) {
    ...
    if (moves.has("hiddenpower") && (species.id === "ninetales" || species.id === "electrode" || species.id === "jolteon" || species.id === "zapdos" || species.id === "blastoise" || species.id === "butterfree" || species.id === "pikachu" || species.id === "raichu")) {
      ivs.atk = 0;
      ivs.def = 30;
    }
    if (moves.has("hiddenpower") && (species.id === "vileplume" || species.id === "magneton" || species.id === "victreebel")) {
      ivs.atk = 1;
      ivs.spa = 30;
      ivs.spd = 30;
    }
    if (moves.has("hiddenpower") && (species.id === "persian" || species.id === "gengar" || species.id === "exeggutor" || species.id === "porygon")) {
      ivs.atk = 1;
      ivs.def = 30;
      ivs.spa = 30;
      ivs.spd = 30;
...
var teams_default = RandomRGTeams;
