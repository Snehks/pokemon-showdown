...
const Teams = new class Teams2 {
  pack(team) {
    ...
    for (const set of team) {
      ...
      if (set.currentHp !== void 0 || set.status || set.movePP || set.databaseId || set.moveMaxPP) {
        buf += `|${set.currentHp !== void 0 ? set.currentHp : ""}`;
        buf += `|${set.status || ""}`;
        buf += `|${set.statusDuration !== void 0 && set.statusDuration >= 0 ? set.statusDuration : ""}`;
