...
function makePageHeader(user, pageid) {
  ...
  buf.push(/* @__PURE__ */ Chat.h(
    ...
    /* @__PURE__ */ Chat.h("i", { class: "fa fa-refresh" }),
    " Refresh"
  ));
  ...
  giveaways: {
    ...
    create(args, user) {
      ...
      return /* @__PURE__ */ Chat.h("div", { class: "pad" }, makePageHeader(this.user, "create"), (() => {
        ...
        switch (type) {
          case "lottery":
            return /* @__PURE__ */ Chat.h(Chat.Fragment, null, /* @__PURE__ */ Chat.h("h2", null, "Make a Lottery Giveaway"), /* @__PURE__ */ Chat.h("form", { "data-submitsend": "/giveaway create lottery {giver}|{ot}|{tid}|{game}|{winners}|{ivs}|{ball}|{info}|{set}" }, /* @__PURE__ */ Chat.h("label", { for: "giver" }, "Giver: "), /* @__PURE__ */ Chat.h("input", { name: "giver" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "ot" }, "OT: "), /* @__PURE__ */ Chat.h("input", { name: "ot" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "tid" }, "TID: "), /* @__PURE__ */ Chat.h("input", { name: "tid" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), "Game: ", /* @__PURE__ */ Chat.h("div", null, /* @__PURE__ */ Chat.h("input", { type: "radio", id: "bdsp", name: "game", value: "bdsp" }), /* @__PURE__ */ Chat.h("label", { for: "bdsp" }, "BDSP"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "swsh", name: "game", value: "swsh" }), /* @__PURE__ */ Chat.h("label", { for: "swsh" }, "SwSh"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "sv", name: "game", value: "sv" }), /* @__PURE__ */ Chat.h("label", { for: "sv" }, "SV"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "plza", name: "game", value: "plza", checked: true }), /* @__PURE__ */ Chat.h("label", { for: "plza" }, "Z-A")), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "winners" }, "Number of winners: "), /* @__PURE__ */ Chat.h("input", { name: "winners" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), generatePokeballDropdown(), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "ivs" }, 'IVs (Formatted like "1/30/31/X/HT/30"): '), /* @__PURE__ */ Chat.h("input", { name: "ivs" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "set" }, "Prize:"), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("textarea", { style: { width: "70%", height: "300px" }, placeholder: "Paste set importable", name: "set" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("label", { for: "info" }, "Additional information (if any):"), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("textarea", { style: { width: "50%", height: "100px" }, placeholder: "Add any additional info", name: "info" }), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("button", { class: "button", type: "submit" }, "Create Lottery Giveaway")));
          case "question":
            return /* @__PURE__ */ Chat.h(Chat.Fragment, null, /* @__PURE__ */ Chat.h("h2", null, "Make a Question Giveaway"), /* @__PURE__ */ Chat.h(
              "form",
              {
                "data-submitsend": "/giveaway create question {giver}|{ot}|{tid}|{game}|{question}|{answers}|{ivs}|{ball}|{info}|{set}"
              },
              /* @__PURE__ */ Chat.h("label", { for: "giver" }, "Giver:"),
              /* @__PURE__ */ Chat.h("input", { name: "giver" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "ot" }, "OT:"),
              /* @__PURE__ */ Chat.h("input", { name: "ot" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "tid" }, "TID:"),
              /* @__PURE__ */ Chat.h("input", { name: "tid" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              "Game: ",
              /* @__PURE__ */ Chat.h("div", null, /* @__PURE__ */ Chat.h("input", { type: "radio", id: "bdsp", name: "game", value: "bdsp" }), /* @__PURE__ */ Chat.h("label", { for: "bdsp" }, "BDSP"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "swsh", name: "game", value: "swsh" }), /* @__PURE__ */ Chat.h("label", { for: "swsh" }, "SwSh"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "sv", name: "game", value: "sv" }), /* @__PURE__ */ Chat.h("label", { for: "sv" }, "SV"), /* @__PURE__ */ Chat.h("input", { type: "radio", id: "plza", name: "game", value: "plza", checked: true }), /* @__PURE__ */ Chat.h("label", { for: "plza" }, "Z-A")),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "question" }, "Question:"),
              /* @__PURE__ */ Chat.h("input", { name: "question" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "answers" }, "Answers (separated by comma):"),
              /* @__PURE__ */ Chat.h("input", { name: "answers" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              generatePokeballDropdown(),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "ivs" }, 'IVs (Formatted like "1/30/31/X/HT/30"): '),
              /* @__PURE__ */ Chat.h("input", { name: "ivs" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "set" }),
              /* @__PURE__ */ Chat.h("textarea", { style: { width: "70%", height: "300px" }, placeholder: "Paste set importable here", name: "set" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("label", { for: "info" }, "Additional information (if any):"),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("textarea", { style: { width: "50%", height: "100px" }, placeholder: "Add any additional info", name: "info" }),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("br", null),
              /* @__PURE__ */ Chat.h("button", { class: "button", type: "submit" }, "Create Question Giveaway")
            ));
        }
      })());
    },
            ...
            if (wifiData.storedGiveaways.lottery.includes(giveaway)) {
              ...
              buf.push(/* @__PURE__ */ Chat.h("div", { class: "infobox" }, /* @__PURE__ */ Chat.h("h3", { style: { textAlign: "center" } }, "Lottery"), /* @__PURE__ */ Chat.h("hr", null), /* @__PURE__ */ Chat.h("strong", null, "Game:"), " ", gameName[giveaway.game], /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("strong", null, "Giver:"), " ", giveaway.targetUserID, ", ", /* @__PURE__ */ Chat.h("strong", null, "OT:"), " ", giveaway.ot, ", ", /* @__PURE__ */ Chat.h("strong", null, "TID:"), " ", giveaway.tid, /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("strong", null, "Question:"), " ", giveaway.question, /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("strong", null, "Answer", Chat.plural(giveaway.answers.length, "s"), ":"), " ", giveaway.answers.join(", "), /* @__PURE__ */ Chat.h("br", null), /* @__PURE__ */ Chat.h("strong", null, "Pok\xE9 Ball:"), " ", /* @__PURE__ */ Chat.h("psicon", { item: giveaway.ball }), /* @__PURE__ */ Chat.h("details", null, /* @__PURE__ */ Chat.h("summary", null, /* @__PURE__ */ Chat.h("psicon", { pokemon: giveaway.prize.species }), " Prize"), /* @__PURE__ */ Chat.h(Chat.JSX.FormatText, { isTrusted: true }, Giveaway.convertIVs(giveaway.prize, giveaway.ivs))), !!giveaway.extraInfo?.trim() && /* @__PURE__ */ Chat.h(Chat.Fragment, null, /* @__PURE__ */ Chat.h("hr", null), /* @__PURE__ */ Chat.h("details", null, /* @__PURE__ */ Chat.h("summary", null, "Extra Info"), /* @__PURE__ */ Chat.h(Chat.JSX.FormatText, { isTrusted: true }, giveaway.extraInfo.trim()))), /* @__PURE__ */ Chat.h("hr", null), /* @__PURE__ */ Chat.h(
                ...
                "button",
                {
                  ...
                  style: { float: "right" },
                  name: "send",
                  value: `/giveaway create question ${giveaway.targetUserID}|${giveaway.ot}|${giveaway.tid}|${giveaway.game}|${giveaway.question}|${giveaway.answers.join(",")}|${giveaway.ivs.join("/")}|${giveaway.ball}|${giveaway.extraInfo.trim().replace(/\n/g, "<br />")}|${Teams.pack([giveaway.prize])}`
                },
                "Create giveaway"
              )));
            }
            ...
            switch (type) {
              ...
              case "question":
                return /* @__PURE__ */ Chat.h(
                  ...
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("button", { class: "button", type: "submit" }, "Store Question Giveaway")
                );
            }
          })());
        }
            ...
            switch (type) {
              ...
              case "question":
                return /* @__PURE__ */ Chat.h(
                  ...
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("label", { for: "set" }),
                  /* @__PURE__ */ Chat.h("textarea", { style: { width: "70%", height: "300px" }, placeholder: "Paste set importable", name: "set" }),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("label", { for: "info" }, "Additional information (provide a link of proof here):"),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("textarea", { style: { width: "50%", height: "100px" }, placeholder: "Add any additional info", name: "info" }),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("br", null),
                  /* @__PURE__ */ Chat.h("button", { class: "button", type: "submit" }, "Submit Question Giveaway")
                );
            }
          })());
        }
