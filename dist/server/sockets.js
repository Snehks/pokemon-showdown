...
var import_static_server = require("../lib/static-server");
/**
 * Connections
...
${e.stack}`), `Socket process ${process.pid}`);
    ...
    try {
      ...
      const cssServer = new import_static_server.StaticServer("./config");
      const avatarServer = new import_static_server.StaticServer("./config/avatars");
      const staticServer = new import_static_server.StaticServer("./server/static");
...
function start(processCount) {
  ...
  Sockets.listen(port, void 0, processCount);
}
