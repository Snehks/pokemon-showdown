...
exports.translations = {
    ...
    strings: {
        ...
        "This room has slow-chat enabled. You can only talk once every ${time} seconds.": "O slow-chat desta sala está ativado. Você apenas pode falar a cada ${time} segundos.",
