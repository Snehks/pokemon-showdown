...
class FSPath {
    ...
    async safeWrite(data, options = {}) {
        await (0, exports.FS)(this.path + '.NEW').write(data, options);
        await (0, exports.FS)(this.path + '.NEW').rename(this.path);
    }
    ...
    createWriteStream(options = {}) {
        if (global.Config?.nofswriting) {
            return new streams_1.WriteStream({ write() { } });
        }
...
class FileReadStream extends streams_1.ReadStream {
    constructor(file) {
        super();
