...
exports.GlobalAuth = exports.RoomAuth = exports.Auth = exports.GLOBAL_PERMISSIONS = exports.ROOM_PERMISSIONS = exports.HOST_SYMBOL = exports.PLAYER_SYMBOL = void 0;
const fs_1 = require("../lib/fs");
const dex_data_1 = require("../sim/dex-data");
exports.PLAYER_SYMBOL = '\u2606';
exports.HOST_SYMBOL = '\u2605';
...
class Auth extends Map {
    ...
    static hasPermission(user, permission, target, room, cmd, cmdToken) {
        ...
        else if (typeof target === 'string' && !(0, dex_data_1.toID)(target)) { // empty ID -> target is a group symbol
            targetSymbol = target;
        }
        else {
...
exports.Auth = Auth;
Auth.ROOM_PERMISSIONS = exports.ROOM_PERMISSIONS;
Auth.GLOBAL_PERMISSIONS = exports.GLOBAL_PERMISSIONS;
...
class GlobalAuth extends Auth {
    constructor() {
        ...
        this.sectionLeaders = new Map();
        this.load();
    }
    save() {
        (0, fs_1.FS)('config/usergroups.csv').writeUpdate(() => {
            let buffer = '';
            for (const [userid, groupSymbol] of this) {
    ...
    load() {
        const data = (0, fs_1.FS)('config/usergroups.csv').readIfExistsSync();
