...
exports.commands = exports.pages = exports.Repeats = void 0;
exports.destroy = destroy;
exports.start = start;
const room_faqs_1 = require("./room-faqs");
exports.Repeats = new class {
    constructor() {
    ...
    runRepeat(room, repeat) {
        ...
        const repeater = (targetRoom) => {
            ...
            const repeatedPhrase = repeat.faq ?
                (0, room_faqs_1.visualizeFaq)(room_faqs_1.roomFaqs[targetRoom.roomid][repeat.id]) : Chat.formatText(phrase, true);
...
exports.pages = {
    repeats(args, user) {
        ...
        for (const repeat of room.settings.repeats) {
            ...
            const repeatText = repeat.faq ? room_faqs_1.roomFaqs[room.roomid][repeat.id].source : repeat.phrase;
            const phrase = repeat.faq ? (0, room_faqs_1.visualizeFaq)(room_faqs_1.roomFaqs[room.roomid][repeat.id]) :
...
exports.commands = {
    ...
    repeat(target, room, user, connection, cmd) {
        ...
        this.privateModAction(isByMessages ?
    ...
    repeathelp() {
        this.runBroadcast();
        this.sendReplyBox(`<code>/repeat [minutes], [id], [phrase]</code>: repeats a given phrase every [minutes] minutes. Requires: % @ # ~<br />` +
    ...
    repeatfaq(target, room, user, connection, cmd) {
        ...
        if (!room_faqs_1.roomFaqs[room.roomid]) {
            throw new Chat.ErrorMessage(`This room has no FAQs.`);
        }
        topic = toID((0, room_faqs_1.getAlias)(room.roomid, topic) || topic);
        const faq = room_faqs_1.roomFaqs[room.roomid][topic];
        if (!faq) {
