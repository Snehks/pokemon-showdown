...
exports.challenges = exports.Challenges = exports.BattleInvite = exports.GameChallenge = exports.BattleChallenge = exports.AbstractChallenge = exports.BattleReady = void 0;
/**
 * A bundle of:
 - a ID
 * - a battle format
...
class Challenges extends Map {
    ...
    search(userid1, userid2) {
        ...
        for (const challenge of challenges) {
            if ((challenge.to === userid1 && challenge.from === userid2) ||
...
exports.challenges = new Challenges();
